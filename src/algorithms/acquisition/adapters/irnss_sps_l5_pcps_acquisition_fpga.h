...
#ifndef GNSS_SDR_IRNSS_SPS_L5_PCPS_ACQUISITION_FPGA_H
#define GNSS_SDR_IRNSS_SPS_L5_PCPS_ACQUISITION_FPGA_H
 ...
 */
class IrnssSpsL5PcpsAcquisitionFpga : public AcquisitionInterface
{
public:
    /*!
     * \brief Constructor
     */
    IrnssSpsL5PcpsAcquisitionFpga(const ConfigurationInterface* configuration,
     ...
     * \brief Destructor
     */
    ~IrnssSpsL5PcpsAcquisitionFpga() = default;
    ...
    {
        return "IRNSS_SPS_L5_PCPS_Acquisition_Fpga";
    }
